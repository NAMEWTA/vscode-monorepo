...
declare module 'vscode' {
	...
	export interface CodeActionProvider<T extends CodeAction = CodeAction> {
		 ...
		 * @param token A cancellation token.
		 *
		 * @returns An array of code actions, such as quick fixes or refactorings
	...
	export interface Terminal {
		 ...
		 * shell type of when the terminal was not launched by this extension or for detecting w
	...
	export class TestRunRequest {
		 ...
		 * @param exclude An array of tests to
	...
	export interface LanguageModelChatProvider<T extends LanguageModelChatInformation = LanguageModelChatInformation> {
		...
		/**
		 * Returns the response for a cha
